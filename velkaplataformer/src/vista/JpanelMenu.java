...
public class JpanelMenu extends JPanel implements ActionListener, MouseListener {
	...
	@Override
	public void paint(Graphics g) { // El metodo paint es un metodo de la clase JPanel que se encarga de pintar la
									// imagen sobre el panel

		Dimension dimension = this.getSize();
		ImageIcon icon = new ImageIcon(getClass().getResource("/recursos/FONDOMENU.png")); // Indicamos la ruta de la
																							// imagen ya que si no
																							// saltara error ya que
																							// dectara que es nulo
	...
	public void tituloJuego() {
		 ...
		 * parsear dicha imagen a tipo image para escalar la instancia pegar la imagen a
		 * un JLabel para luego indiar X Y ancho y alto y por último añadimos el titulo
		 */
	...
	/*
	 * Los metodos botonesMenu,botoncontrol y botonSalir se encargan de 1. Recoger
	 * la ruta de la imagen correspondiente a cada botón 2. parsear esa imagen de
	 * imagenIcon a tipo Image para así jugar con su escala es decir su ancho y su
	 * alto 3.Instanciar un boton que tendra la imagen 4.deshabilitar los bordes del
	 * botón por estética 5.deshabilitar que automáticamente se rellene el area del
	 * botón para dar ese efecto
	 */
